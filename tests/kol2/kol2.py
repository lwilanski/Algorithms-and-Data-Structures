...
# tworzą spójny podciąg. Modyfikuję więc algorytm kruskala tak żeby budował tylko ze spójnego podciągu najmniej ważące drzewo.
# Znajduje wszystkie takie drzewa a następnie wybieram to z najmniejszą sumą wag.
...
def beautree(G):
    ...
    for i in range(0, len(edge_list)):
        ...
        if possible and result > curr_weight and edge_counter == n - 1:
            result = curr_weight
